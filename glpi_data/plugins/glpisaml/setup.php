...
define('PLUGIN_GLPISAML_MIN_GLPI', '10.0.00');                                                  // Min required GLPI version
define('PLUGIN_GLPISAML_MAX_GLPI', '11.9.99');                                                  // Max GLPI compat version
...
function plugin_init_glpisaml() : void                                                          //NOSONAR - phpcs:ignore PSR1.Function.CamelCapsMethodName
{
    ...
    SessionManager::registerPluginStatelessPath(PLUGIN_NAME, '#^/front/acs\.php$#');
