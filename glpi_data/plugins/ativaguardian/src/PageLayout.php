...
.ag-badge{display:inline-block;font-size:11px;font-weight:600;border-radius:5px;padding:3px 8px;color:#fff;white-space:nowrap}.ag-badge.bg-success{background:#1f9d70}.ag-badge.bg-danger{background:#dd3f4a}.ag-badge.bg-warning{background:#e6a417;color:#3a2c05}.ag-badge.bg-secondary{background:#7c8b96}.ag-comp{display:flex;flex-direction:column;gap:2px;min-width:0}.ag-comp-ver{color:var(--ag-muted);font-size:10px}.ag-empty{color:var(--ag-muted);padding:22px 17px;text-align:center}.ag-last{color:#365b54}.ag-last small{display:block;color:var(--ag-muted);font-size:10px}
