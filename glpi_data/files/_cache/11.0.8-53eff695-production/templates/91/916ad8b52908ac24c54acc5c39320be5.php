...
class __TwigTemplate_fce03ba5d30114d3124de1fd13fab04a extends Template
{
      ...
      <div class=\"list-group list-group-flush list-group-hoverable\">
         ";
            ...
            foreach ($context['_seq'] as $context["id"] => $context["linked"]) {
                ...
                // line 43
                yield "            ";
                $context["can_delete_relation"] = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "can", [CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "getID", [], "method", false, false, false, 43), Twig\Extension\CoreExtension::constant("UPDATE")], "method", false, false, false, 43);
                // line 44
               ...
               <div class=\"row\">
                  <div class=\"col-auto\">
                     ";
                // line 47
                yield $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("CommonITILObject_CommonITILObject::getLinkName", [(($_v4 =                 // line 48
$context["linked"]) && is_array($_v4) || $_v4 instanceof ArrayAccess ? ($_v4["link"] ?? null) : null), (((($_v5 =                 // line 49
$context["linked"]) && is_array($_v5) || $_v5 instanceof ArrayAccess ? ($_v5["itemtype_2"] ?? null) : null) == CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "getType", [], "method", false, false, false, 49)) && ((($_v6 = $context["linked"]) && is_array($_v6) || $_v6 instanceof ArrayAccess ? ($_v6["items_id_2"] ?? null) : null) == (($_v7 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 49)) && is_array($_v7) || $_v7 instanceof ArrayAccess ? ($_v7["id"] ?? null) : null))), true]);
                // line 51
                yield "
                  </div>
                ...
                if ((($tmp = ($context["can_view_item"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 55
                    yield "                        <a href=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Glpi\Application\View\Extension\ItemtypeExtension']->getItemtypeFormPath((($_v8 = $context["linked"]) && is_array($_v8) || $_v8 instanceof ArrayAccess ? ($_v8["itemtype"] ?? null) : null), (($_v9 = $context["linked"]) && is_array($_v9) || $_v9 instanceof ArrayAccess ? ($_v9["items_id"] ?? null) : null)), "html", null, true);
                    yield "\" class=\"col-9 overflow-hidden text-nowrap\">
                           <i class=\"";
                    // line 56
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Glpi\Application\View\Extension\ItemtypeExtension']->getItemtypeIcon((($_v10 = $context["linked"]) && is_array($_v10) || $_v10 instanceof ArrayAccess ? ($_v10["itemtype"] ?? null) : null)), "html", null, true);
                    yield "\" title=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Glpi\Application\View\Extension\ItemtypeExtension']->getItemtypeName((($_v11 = $context["linked"]) && is_array($_v11) || $_v11 instanceof ArrayAccess ? ($_v11["itemtype"] ?? null) : null)), "html", null, true);
                    yield "\" data-bs-toggle=\"tooltip\"></i>
                           ";
                    // line 57
                    yield CoreExtension::getAttribute($this->env, $this->source, ($context["new_itilobject"] ?? null), "getStatusIcon", [(($_v12 = CoreExtension::getAttribute($this->env, $this->source, ($context["new_itilobject"] ?? null), "fields", [], "any", false, false, false, 57)) && is_array($_v12) || $_v12 instanceof ArrayAccess ? ($_v12["status"] ?? null) : null)], "method", false, false, false, 57);
                    yield "
                           <span title=\"";
                    // line 58
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v13 = CoreExtension::getAttribute($this->env, $this->source, ($context["new_itilobject"] ?? null), "fields", [], "any", false, false, false, 58)) && is_array($_v13) || $_v13 instanceof ArrayAccess ? ($_v13["name"] ?? null) : null), "html", null, true);
                    yield "\" data-bs-toggle=\"tooltip\">
                              ";
                    // line 59
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v14 = CoreExtension::getAttribute($this->env, $this->source, ($context["new_itilobject"] ?? null), "fields", [], "any", false, false, false, 59)) && is_array($_v14) || $_v14 instanceof ArrayAccess ? ($_v14["name"] ?? null) : null), "html", null, true);
                    yield "
                           </span>
                           (";
                    // line 61
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v15 = CoreExtension::getAttribute($this->env, $this->source, ($context["new_itilobject"] ?? null), "fields", [], "any", false, false, false, 61)) && is_array($_v15) || $_v15 instanceof ArrayAccess ? ($_v15["id"] ?? null) : null), "html", null, true);
                    yield ")
                        </a>
                     ";
                } else {
                    ...
                    yield "                        <span class=\"col-9 overflow-hidden text-nowrap text-muted\">
                           <i class=\"";
                    // line 65
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Glpi\Application\View\Extension\ItemtypeExtension']->getItemtypeIcon((($_v16 = $context["linked"]) && is_array($_v16) || $_v16 instanceof ArrayAccess ? ($_v16["itemtype"] ?? null) : null)), "html", null, true);
                    yield "\" title=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Glpi\Application\View\Extension\ItemtypeExtension']->getItemtypeName((($_v17 = $context["linked"]) && is_array($_v17) || $_v17 instanceof ArrayAccess ? ($_v17["itemtype"] ?? null) : null)), "html", null, true);
                    yield "\" data-bs-toggle=\"tooltip\"></i>
                           <span title=\"";
                    // line 66
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v18 = CoreExtension::getAttribute($this->env, $this->source, ($context["new_itilobject"] ?? null), "fields", [], "any", false, false, false, 66)) && is_array($_v18) || $_v18 instanceof ArrayAccess ? ($_v18["name"] ?? null) : null), "html", null, true);
                    yield "\" data-bs-toggle=\"tooltip\">
                              ";
                    // line 67
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v19 = CoreExtension::getAttribute($this->env, $this->source, ($context["new_itilobject"] ?? null), "fields", [], "any", false, false, false, 67)) && is_array($_v19) || $_v19 instanceof ArrayAccess ? ($_v19["name"] ?? null) : null), "html", null, true);
                    yield "
                           </span>
                           (";
                    // line 69
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v20 = CoreExtension::getAttribute($this->env, $this->source, ($context["new_itilobject"] ?? null), "fields", [], "any", false, false, false, 69)) && is_array($_v20) || $_v20 instanceof ArrayAccess ? ($_v20["id"] ?? null) : null), "html", null, true);
                    yield ")
                        </span>
                     ";
                }
...
";
        // line 94
        if ((($context["canupdate"] ?? null) &&  !(((CoreExtension::getAttribute($this->env, $this->source, ($context["params"] ?? null), "template_preview", [], "array", true, true, false, 94) &&  !(null === (($_v21 = ($context["params"] ?? null)) && is_array($_v21) || $_v21 instanceof ArrayAccess ? ($_v21["template_preview"] ?? null) : null)))) ? ((($_v22 = ($context["params"] ?? null)) && is_array($_v22) || $_v22 instanceof ArrayAccess ? ($_v22["template_preview"] ?? null) : null)) : (false)))) {
            // line 95
            yield "   ";
            $context["has_pending_link"] = (Twig\Extension\CoreExtension::length($this->env->getCharset(), (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["params"] ?? null), "_link", [], "array", false, true, false, 95), "items_id_2", [], "array", true, true, false, 95) &&  !(null === (($_v23 = (($_v24 = ($context["params"] ?? null)) && is_array($_v24) || $_v24 instanceof ArrayAccess ? ($_v24["_link"] ?? null) : null)) && is_array($_v23) || $_v23 instanceof ArrayAccess ? ($_v23["items_id_2"] ?? null) : null)))) ? ((($_v25 = (($_v26 = ($context["params"] ?? null)) && is_array($_v26) || $_v26 instanceof ArrayAccess ? ($_v26["_link"] ?? null) : null)) && is_array($_v25) || $_v25 instanceof ArrayAccess ? ($_v25["items_id_2"] ?? null) : null)) : (""))) > 0);
            // line 96
            yield "
   ";
            // line 98
            yield "   ";
            $context["used_items"] = [ (string)CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "getType", [], "method", false, false, false, 98) => [(($_v27 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 98)) && is_array($_v27) || $_v27 instanceof ArrayAccess ? ($_v27["id"] ?? null) : null)]];
            // line 99
            yield "   ";
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(($context["linked_itilobjects"] ?? null));
            foreach ($context['_seq'] as $context["_key"] => $context["linked"]) {
                // line 100
                yield "      ";
                $context["linked_type"] = (($_v28 = $context["linked"]) && is_array($_v28) || $_v28 instanceof ArrayAccess ? ($_v28["itemtype"] ?? null) : null);
                // line 101
                yield "      ";
                $context["linked_id"] = (($_v29 = $context["linked"]) && is_array($_v29) || $_v29 instanceof ArrayAccess ? ($_v29["items_id"] ?? null) : null);
                // line 102
                yield "      ";
                ...
                // line 105
                yield "      ";
                $context["used_items"] = Twig\Extension\CoreExtension::merge(($context["used_items"] ?? null), [ (string)($context["linked_type"] ?? null) => Twig\Extension\CoreExtension::merge((($_v30 = ($context["used_items"] ?? null)) && is_array($_v30) || $_v30 instanceof ArrayAccess ? ($_v30[(($_v31 = ($context["linked_type"] ?? null)) instanceof \Stringable ? (string) $_v31 : $_v31)] ?? null) : null), [($context["linked_id"] ?? null)])]);
                // line 106
                yield "   ";
            }
            $_parent = $context['_parent'];
