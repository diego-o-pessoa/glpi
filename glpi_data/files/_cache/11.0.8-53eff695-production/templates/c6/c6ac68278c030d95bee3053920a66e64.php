...
class __TwigTemplate_88a5634efd28b7265f6d3f1afe5cb486 extends Template
{
   ...
   <section class=\"accordion-item\" aria-label=\"";
      ...
      <div class=\"accordion-header\" id=\"heading-main-item\">
        ...
        yield "\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#item-main\" aria-expanded=\"true\" aria-controls=\"ticket-main\">
            ...
            <span class=\x27status-recall\x27>
                ";
        // line 53
...
$context["note"]]);
   ...
   ";
      ...
      ";
            ...
            // line 392
            yield "      ";
            $context["analysis_show"] = (((CoreExtension::getAttribute($this->env, $this->source, ($context["headers_states"] ?? null), "analysis", [], "array", true, true, false, 392) && ((($_v41 = ($context["headers_states"] ?? null)) && is_array($_v41) || $_v41 instanceof ArrayAccess ? ($_v41["analysis"] ?? null) : null) == "true"))) ? (true) : (false));
            // line 393
            yield "      <section class=\"accordion-item\" aria-label=\"";
...
$context["analysis_field"], (($_v42 = CoreExtension::getAttribute($this->env, $this->source,                     // line 411
($context["item"] ?? null), "fields", [], "any", false, false, false, 411)) && is_array($_v42) || $_v42 instanceof ArrayAccess ? ($_v42[(($_v43 = $context["analysis_field"]) instanceof \Stringable ? (string) $_v43 : $_v43)] ?? null) : null),                     // line 412
   ...
   ";
      ...
      ";
            ...
            foreach ($context['_seq'] as $context["plans_field"] => $context["label"]) {
                // line 434
                yield "         ";
                if ((CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "isField", [$context["plans_field"]], "method", false, false, false, 434) && (Twig\Extension\CoreExtension::length($this->env->getCharset(), Twig\Extension\CoreExtension::trim((($_v44 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 434)) && is_array($_v44) || $_v44 instanceof ArrayAccess ? ($_v44[(($_v45 = $context["plans_field"]) instanceof \Stringable ? (string) $_v45 : $_v45)] ?? null) : null))) > 0))) {
                    // line 435
                    yield "            ";
      ...
      ";
            // line 439
            $context["plans_show"] = (((CoreExtension::getAttribute($this->env, $this->source, ($context["headers_states"] ?? null), "plans", [], "array", true, true, false, 439) && ((($_v46 = ($context["headers_states"] ?? null)) && is_array($_v46) || $_v46 instanceof ArrayAccess ? ($_v46["plans"] ?? null) : null) == "true"))) ? (true) : (false));
            // line 440
            yield "      <section class=\"accordion-item\" aria-label=\"";
...
$context["plans_field"], (($_v47 = CoreExtension::getAttribute($this->env, $this->source,                     // line 458
($context["item"] ?? null), "fields", [], "any", false, false, false, 458)) && is_array($_v47) || $_v47 instanceof ArrayAccess ? ($_v47[(($_v48 = $context["plans_field"]) instanceof \Stringable ? (string) $_v48 : $_v48)] ?? null) : null),                     // line 459
...
($context["field_options"] ?? null), ["enable_richtext" => true, "is_horizontal" => false])]);
   ...
   ";
        // line 472
        $context["linked_itilobjects_show"] = (((CoreExtension::getAttribute($this->env, $this->source, ($context["headers_states"] ?? null), "linked_itilobjects", [], "array", true, true, false, 472) && ((($_v49 = ($context["headers_states"] ?? null)) && is_array($_v49) || $_v49 instanceof ArrayAccess ? ($_v49["linked_itilobjects"] ?? null) : null) == "true"))) ? (true) : (false));
        // line 473
        yield "   ";
      ...
      <div class=\"accordion-header\" id=\"linked_itilobjects-heading\" title=\"";
        ...
        yield "\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#linked_itilobjects\" aria-expanded=\"true\" aria-controls=\"linked_itilobjects\">
            ...
            ";
        // line 478
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 478) && ((((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["params"] ?? null), "_link", [], "array", false, true, false, 478), "items_id_2", [], "array", true, true, false, 478) &&  !(null === (($_v50 = (($_v51 = ($context["params"] ?? null)) && is_array($_v51) || $_v51 instanceof ArrayAccess ? ($_v51["_link"] ?? null) : null)) && is_array($_v50) || $_v50 instanceof ArrayAccess ? ($_v50["items_id_2"] ?? null) : null)))) ? ((($_v52 = (($_v53 = ($context["params"] ?? null)) && is_array($_v53) || $_v53 instanceof ArrayAccess ? ($_v53["_link"] ?? null) : null)) && is_array($_v52) || $_v52 instanceof ArrayAccess ? ($_v52["items_id_2"] ?? null) : null)) : (0)) > 0))) {
            // line 479
            yield "               ";
...
\$(function() {
   if (\$(window).width() < 768) { // medium breakpoint (Todo check if it\x27s possible to get bootstrap breakpoints withint javascript)
...
\$(function() {
    ...
    \$(\x27#itil-data .accordion-header\x27).on(\x27show.bs.tooltip\x27, function(e) {
        if (!\$(\x27#itil-object-container\x27).hasClass(\x27right-collapsed\x27) && \$(e.target).hasClass(\x27accordion-header\x27)) {
            e.preventDefault();
        }
    });
});
...
var reloadCategory = function() {
    var type = \$(\x27[name=type]\x27).val();

    \$(\x27#category_block_";
        // line 526
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["rand"] ?? null), "html", null, true);
        yield " .field-container\x27).load(
        \x27";
        // line 527
        ...
        {
            \x27type\x27: type,
            \x27entity_restrict\x27: ";
        // line 530
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v54 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 530)) && is_array($_v54) || $_v54 instanceof ArrayAccess ? ($_v54["entities_id"] ?? null) : null), "html", null, true);
        yield ",
            \x27value\x27: ";
        // line 531
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v55 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 531)) && is_array($_v55) || $_v55 instanceof ArrayAccess ? ($_v55["itilcategories_id"] ?? null) : null), "html", null, true);
        yield ",
        }
    );
};
