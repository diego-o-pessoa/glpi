...
class __TwigTemplate_6854e992e2788d849cfe82202c59ca42 extends Template
{
...
($context["field_options"] ?? null))]);
        ...
        <div class=\"card-body mx-n2 border-top d-flex flex-row-reverse align-items-start flex-wrap py-2\">
            ";
        // line 78
        yield $macros["inputs"]->getTemplateForMacro("macro_submit", $context, 78, $this->getSourceContext())->macro_submit(...["add", _x("button", "Add"), "", ["icon" => "ti ti-plus"]]);
        yield "
        </div>
    </form>
</div>
