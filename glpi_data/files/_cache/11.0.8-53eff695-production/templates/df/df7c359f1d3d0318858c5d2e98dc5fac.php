...
class __TwigTemplate_8072f68ac7198e20c0b31463d5fb6299 extends Template
{
...
";
        ...
        if ((($tmp = ($context["pending_reason"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 65
            yield "    <span class=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (($_v4 = ($context["pending_reason_contexts"] ?? null)) && is_array($_v4) || $_v4 instanceof ArrayAccess ? ($_v4[(($_v5 = ($context["pending_reason_selected_context"] ?? null)) instanceof \Stringable ? (string) $_v5 : $_v5)] ?? null) : null), "className", [], "any", false, false, false, 65), "html", null, true);
            yield " ";
            yield (((($tmp = ($context["display_for_parent"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("mt-1 w-100 text-truncate") : (""));
            yield "\">
      ";
            // line 66
            yield CoreExtension::getAttribute($this->env, $this->source, (($_v6 = ($context["pending_reason_contexts"] ?? null)) && is_array($_v6) || $_v6 instanceof ArrayAccess ? ($_v6[(($_v7 = ($context["pending_reason_selected_context"] ?? null)) instanceof \Stringable ? (string) $_v7 : $_v7)] ?? null) : null), "icon", [], "any", false, false, false, 66);
            yield "
        ";
            // line 67
            yield (CoreExtension::getAttribute($this->env, $this->source, (($_v8 = ($context["pending_reason_contexts"] ?? null)) && is_array($_v8) || $_v8 instanceof ArrayAccess ? ($_v8[(($_v9 = ($context["pending_reason_selected_context"] ?? null)) instanceof \Stringable ? (string) $_v9 : $_v9)] ?? null) : null), "text", [], "any", false, false, false, 67) . Twig\Extension\CoreExtension::sprintf(": %s", CoreExtension::getAttribute($this->env, $this->source, ($context["pending_reason"] ?? null), "getLink", [], "method", false, false, false, 67)));
            yield "
