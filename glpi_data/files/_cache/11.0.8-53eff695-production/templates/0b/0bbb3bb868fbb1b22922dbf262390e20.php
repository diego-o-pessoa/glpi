...
class __TwigTemplate_82c9c54a2f2f35cc942f34207f272273 extends Template
{
...
";
   ...
   ";
         ...
         <div class=\"mb-3 col-12 col-sm-4\">
            ...
            <span id=\x27inventory_status\x27>";
                // line 112
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Unknown"), "html", null, true);
                yield "</span>
         </div>
      ...
      <script>
      \$(function () {
         \$(\x27#update-status\x27).on(\x27click\x27, function() {
            var icon = \$(this);
            icon.addClass(\x27icon-rotate\x27);
            \$.ajax({
               type: \x27POST\x27,
               ...
               success: function(json) {
                  \$(\x27#agent_status\x27).text(json.answer);
               },
               complete: function() {
                  icon.removeClass(\x27icon-rotate\x27);
               }
            });
         });

         \$(\x27#update-inventory\x27).on(\x27click\x27, function() {
            var icon = \$(this);
            icon.addClass(\x27icon-rotate\x27);
            \$.ajax({
               type: \x27POST\x27,
               ...
               success: function(json) {
                  \$(\x27#inventory_status\x27).text(json.answer);
               },
               complete: function() {
                  icon.removeClass(\x27icon-rotate\x27);
               }
