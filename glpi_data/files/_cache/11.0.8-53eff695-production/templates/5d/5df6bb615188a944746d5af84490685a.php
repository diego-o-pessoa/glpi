...
class __TwigTemplate_1dee2df4d1a3d97f5baebf6dee76056c extends Template
{
...
";
        ...
        let container = document.createElement(\x27span\x27);
        if (option.id === \x27ASC\x27) {
            container.innerHTML = \x27<i class=\"ti ti-sort-ascending me-1\"></i>\x27 + _.escape(option.text);
        } else if (option.id === \x27DESC\x27) {
            container.innerHTML = \x27<i class=\"ti ti-sort-descending me-1\"></i>\x27 + _.escape(option.text);
        }
